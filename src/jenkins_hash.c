/*
	Author: Bob Jenkins
	Website: http://www.burtleburtle.net/bob/hash/doobs.html
*/
...
--------------------------------------------------------------------
*/
unsigned jenkins_hash( k, length, initval)
register unsigned char *k;        /* the key */
register unsigned  length;   /* the length of the key */
register unsigned  initval;  /* the previous hash, or an arbitrary value */
{
