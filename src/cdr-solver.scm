...
(module cdr-solver
        ...
        (export <cdr-solver-capabilities>
                ...
                (cdr-solver/check-initial-expr solver expr)
                (cdr-solver/check-bad-at-frame solver level)
                (cdr-solver/check-predecessor solver level cube)
                (cdr-solver/check-predecessor-expr solver level expr)
                ...
                (cdr-solver/generalize-reachability-target solver level target-expr)
                (cdr-solver/generalize-induction-target solver target-expr)
                (cdr-solver/state-formulas-imply? solver antecedents consequent)
                (cdr-solver/minimize-state-formula solver expr)
                (cdr-solver/minimize-obligation-frame solver obligations)
...
(define-generic (cdr-solver/check-initial-expr solver expr))
(define-generic (cdr-solver/check-bad-at-frame solver level))
(define-generic (cdr-solver/check-predecessor solver level cube))
(define-generic (cdr-solver/check-predecessor-expr solver level expr))
...
(define-generic (cdr-solver/generalize-reachability-target solver level target-expr))
(define-method (cdr-solver/generalize-reachability-target (solver <cdr-solver>) (level <primitive>) (target-expr <sal-expr>))
  target-expr)
(define-generic (cdr-solver/generalize-induction-target solver target-expr))
(define-method (cdr-solver/generalize-induction-target (solver <cdr-solver>) (target-expr <sal-expr>))
  target-expr)
(define-generic (cdr-solver/state-formulas-imply? solver antecedents consequent))
(define-method (cdr-solver/state-formulas-imply? (solver <cdr-solver>) (antecedents <primitive>) (consequent <sal-expr>))
  #f)
(define-generic (cdr-solver/minimize-state-formula solver expr))
(define-method (cdr-solver/minimize-state-formula (solver <cdr-solver>) (expr <sal-expr>))
  expr)
(define-generic (cdr-solver/minimize-obligation-frame solver obligations))
(define-method (cdr-solver/minimize-obligation-frame (solver <cdr-solver>) (obligations <primitive>))
  obligations)
